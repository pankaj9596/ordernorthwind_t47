		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Order ",
									"targetURL": "#comsapordernorthwind-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapordernorthwind-display": {
								"semanticObject": "comsapordernorthwind",
								"action": "display",
								"description": "Northwind Order List",
								"title": "Order ",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.ordernorthwind",
									"url": sap.ui.require.toUrl("com/sap/ordernorthwind")
								}
							}
						}
					}
